    ...
    class FileCapsule implements ArrayAccess
    {
        ...
        private function check()
        {
            if(!is_readable($this->getTarget())){
                throw new TargetIsNotReadableException(sprintf('%s hedefiniz okunmaya karşı korumalı', $this->getTarget()));
            }
            if(!is_writeable($this->getTarget())){
                throw new TargetIsNotWriteableException(sprintf('%s hedefiniz yazmaya karşı korumalı', $this->getTarget()));
            }
